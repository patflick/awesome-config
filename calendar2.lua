...
-- source: github.com/TheMarex/delightful
-- again modified by Patrick Flick:
...
function switchNaughtyMonth(switchMonths)
        ...
        -- go through all layout boxes: fixed-layout->first widget->marginbox->widget
        calendar[3].box._drawable.widget.widgets[1].widget:set_markup(string.format('<span font_desc="%s">%s</span>', "monospace", displayMonth(calendar[1], calendar[2], 2)))
end
